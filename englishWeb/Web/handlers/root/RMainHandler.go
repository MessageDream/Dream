...
func (self *RMainHandler) Get() {
	/*
		...
		page := 1
		limit := 5
		pages, pageout, beginnum, endnum, offset := common.Pages(cs_topics, page, limit)

		self.Data["topic_pagesbar"] = common.Pagesbar("", cs_topics, pages, pageout, beginnum, endnum, 2)

		self.Data["topic_hotness"] = bll.GetAllTopic(offset, limit, "hotness")
