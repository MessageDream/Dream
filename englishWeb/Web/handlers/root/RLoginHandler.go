...
func (self *RLoginHandler) Get() {
	browser := ""
	switch {
	case common.Rex(self.Ctx.Request.UserAgent(), "MSIE 5.0"):
		browser = "MSIE 5.0"
	case common.Rex(self.Ctx.Request.UserAgent(), "MSIE 5.5"):
		browser = "MSIE 5.5"
	}
...
func (self *RLoginHandler) Post() {
	...
	if username != "" && password != "" {
		...
		if userInfo := bll.GetUserByNickname(username); userInfo.Nickname != "" {

			if common.Validate_password(userInfo.Password, password) && userInfo.Role == -1000 {
